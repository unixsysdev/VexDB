...
type StorageServiceClient interface {
	...
	InsertVectorStream(ctx context.Context, opts ...grpc.CallOption) (StorageService_InsertVectorStreamClient, error)
	// Search operations
	Search(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (*SearchResponse, error)
	SearchStream(ctx context.Context, opts ...grpc.CallOption) (StorageService_SearchStreamClient, error)
	// Delete operations
	DeleteVectors(ctx context.Context, in *DeleteRequest, opts ...grpc.CallOption) (*DeleteResponse, error)
	DeleteVectorsStream(ctx context.Context, opts ...grpc.CallOption) (StorageService_DeleteVectorsStreamClient, error)
	// Cluster management
...
func (c *storageServiceClient) InsertVector(ctx context.Context, in *InsertRequest, opts ...grpc.CallOption) (*InsertResponse, error) {
	...
	err := c.cc.Invoke(ctx, StorageService_InsertVector_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storageServiceClient) InsertVectorStream(ctx context.Context, opts ...grpc.CallOption) (StorageService_InsertVectorStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &StorageService_ServiceDesc.Streams[0], StorageService_InsertVectorStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &storageServiceInsertVectorStreamClient{stream}
	return x, nil
}

type StorageService_InsertVectorStreamClient interface {
	Send(*InsertRequest) error
	Recv() (*InsertResponse, error)
	grpc.ClientStream
}

type storageServiceInsertVectorStreamClient struct {
	grpc.ClientStream
}

func (x *storageServiceInsertVectorStreamClient) Send(m *InsertRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *storageServiceInsertVectorStreamClient) Recv() (*InsertResponse, error) {
...
func (c *storageServiceClient) Search(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (*SearchResponse, error) {
	...
	err := c.cc.Invoke(ctx, StorageService_Search_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storageServiceClient) SearchStream(ctx context.Context, opts ...grpc.CallOption) (StorageService_SearchStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &StorageService_ServiceDesc.Streams[1], StorageService_SearchStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &storageServiceSearchStreamClient{stream}
	return x, nil
}

type StorageService_SearchStreamClient interface {
	Send(*SearchRequest) error
	Recv() (*SearchResponse, error)
	grpc.ClientStream
}

type storageServiceSearchStreamClient struct {
	grpc.ClientStream
}

func (x *storageServiceSearchStreamClient) Send(m *SearchRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *storageServiceSearchStreamClient) Recv() (*SearchResponse, error) {
...
func (c *storageServiceClient) DeleteVectors(ctx context.Context, in *DeleteRequest, opts ...grpc.CallOption) (*DeleteResponse, error) {
	...
	err := c.cc.Invoke(ctx, StorageService_DeleteVectors_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storageServiceClient) DeleteVectorsStream(ctx context.Context, opts ...grpc.CallOption) (StorageService_DeleteVectorsStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &StorageService_ServiceDesc.Streams[2], StorageService_DeleteVectorsStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &storageServiceDeleteVectorsStreamClient{stream}
	return x, nil
}

type StorageService_DeleteVectorsStreamClient interface {
	Send(*DeleteRequest) error
	Recv() (*DeleteResponse, error)
	grpc.ClientStream
}

type storageServiceDeleteVectorsStreamClient struct {
	grpc.ClientStream
}

func (x *storageServiceDeleteVectorsStreamClient) Send(m *DeleteRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *storageServiceDeleteVectorsStreamClient) Recv() (*DeleteResponse, error) {
...
func (c *storageServiceClient) GetClusterInfo(ctx context.Context, in *ClusterInfo, opts ...grpc.CallOption) (*ClusterInfo, error) {
	out := new(ClusterInfo)
	err := c.cc.Invoke(ctx, StorageService_GetClusterInfo_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storageServiceClient) GetClusterStatus(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ClusterStatus, error) {
	...
	err := c.cc.Invoke(ctx, StorageService_GetClusterStatus_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storageServiceClient) GetMetrics(ctx context.Context, in *MetricsRequest, opts ...grpc.CallOption) (*MetricsResponse, error) {
	...
	err := c.cc.Invoke(ctx, StorageService_GetMetrics_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storageServiceClient) UpdateConfig(ctx context.Context, in *ConfigUpdateRequest, opts ...grpc.CallOption) (*ConfigUpdateResponse, error) {
	...
	err := c.cc.Invoke(ctx, StorageService_UpdateConfig_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storageServiceClient) GetConfig(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ConfigUpdateResponse, error) {
	out := new(ConfigUpdateResponse)
	err := c.cc.Invoke(ctx, StorageService_GetConfig_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StorageServiceServer interface {
	...
	InsertVectorStream(StorageService_InsertVectorStreamServer) error
	// Search operations
	Search(context.Context, *SearchRequest) (*SearchResponse, error)
	SearchStream(StorageService_SearchStreamServer) error
	// Delete operations
	DeleteVectors(context.Context, *DeleteRequest) (*DeleteResponse, error)
	DeleteVectorsStream(StorageService_DeleteVectorsStreamServer) error
	// Cluster management
...
func (UnimplementedStorageServiceServer) InsertVectorStream(StorageService_InsertVectorStreamServer) error {
...
func (UnimplementedStorageServiceServer) SearchStream(StorageService_SearchStreamServer) error {
...
func (UnimplementedStorageServiceServer) DeleteVectorsStream(StorageService_DeleteVectorsStreamServer) error {
...
func _StorageService_InsertVectorStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(StorageServiceServer).InsertVectorStream(&storageServiceInsertVectorStreamServer{stream})
}

type StorageService_InsertVectorStreamServer interface {
	Send(*InsertResponse) error
	Recv() (*InsertRequest, error)
	grpc.ServerStream
}

type storageServiceInsertVectorStreamServer struct {
	grpc.ServerStream
}

func (x *storageServiceInsertVectorStreamServer) Send(m *InsertResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *storageServiceInsertVectorStreamServer) Recv() (*InsertRequest, error) {
	m := new(InsertRequest)
...
func _StorageService_SearchStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(StorageServiceServer).SearchStream(&storageServiceSearchStreamServer{stream})
}

type StorageService_SearchStreamServer interface {
	Send(*SearchResponse) error
	Recv() (*SearchRequest, error)
	grpc.ServerStream
}

type storageServiceSearchStreamServer struct {
	grpc.ServerStream
}

func (x *storageServiceSearchStreamServer) Send(m *SearchResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *storageServiceSearchStreamServer) Recv() (*SearchRequest, error) {
	m := new(SearchRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func _StorageService_DeleteVectorsStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(StorageServiceServer).DeleteVectorsStream(&storageServiceDeleteVectorsStreamServer{stream})
}

type StorageService_DeleteVectorsStreamServer interface {
	Send(*DeleteResponse) error
	Recv() (*DeleteRequest, error)
	grpc.ServerStream
}

type storageServiceDeleteVectorsStreamServer struct {
	grpc.ServerStream
}

func (x *storageServiceDeleteVectorsStreamServer) Send(m *DeleteResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *storageServiceDeleteVectorsStreamServer) Recv() (*DeleteRequest, error) {
	m := new(DeleteRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type InsertServiceClient interface {
	// Insert operations
	InsertVector(ctx context.Context, in *InsertRequest, opts ...grpc.CallOption) (*InsertResponse, error)
	InsertVectorStream(ctx context.Context, opts ...grpc.CallOption) (InsertService_InsertVectorStreamClient, error)
	// Batch operations
	InsertBatch(ctx context.Context, in *VectorBatch, opts ...grpc.CallOption) (*InsertResponse, error)
	InsertBatchStream(ctx context.Context, opts ...grpc.CallOption) (InsertService_InsertBatchStreamClient, error)
...
func (c *insertServiceClient) InsertVector(ctx context.Context, in *InsertRequest, opts ...grpc.CallOption) (*InsertResponse, error) {
	out := new(InsertResponse)
	err := c.cc.Invoke(ctx, InsertService_InsertVector_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *insertServiceClient) InsertVectorStream(ctx context.Context, opts ...grpc.CallOption) (InsertService_InsertVectorStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &InsertService_ServiceDesc.Streams[0], InsertService_InsertVectorStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &insertServiceInsertVectorStreamClient{stream}
	return x, nil
}

type InsertService_InsertVectorStreamClient interface {
	Send(*InsertRequest) error
	Recv() (*InsertResponse, error)
	grpc.ClientStream
}

type insertServiceInsertVectorStreamClient struct {
	grpc.ClientStream
}

func (x *insertServiceInsertVectorStreamClient) Send(m *InsertRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *insertServiceInsertVectorStreamClient) Recv() (*InsertResponse, error) {
	m := new(InsertResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *insertServiceClient) InsertBatch(ctx context.Context, in *VectorBatch, opts ...grpc.CallOption) (*InsertResponse, error) {
	out := new(InsertResponse)
	err := c.cc.Invoke(ctx, InsertService_InsertBatch_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *insertServiceClient) InsertBatchStream(ctx context.Context, opts ...grpc.CallOption) (InsertService_InsertBatchStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &InsertService_ServiceDesc.Streams[1], InsertService_InsertBatchStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &insertServiceInsertBatchStreamClient{stream}
	return x, nil
}

type InsertService_InsertBatchStreamClient interface {
	Send(*VectorBatch) error
	Recv() (*InsertResponse, error)
	grpc.ClientStream
}

type insertServiceInsertBatchStreamClient struct {
	grpc.ClientStream
}

func (x *insertServiceInsertBatchStreamClient) Send(m *VectorBatch) error {
	return x.ClientStream.SendMsg(m)
}

func (x *insertServiceInsertBatchStreamClient) Recv() (*InsertResponse, error) {
	m := new(InsertResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *insertServiceClient) GetClusterForVector(ctx context.Context, in *Vector, opts ...grpc.CallOption) (*ClusterInfo, error) {
	out := new(ClusterInfo)
	err := c.cc.Invoke(ctx, InsertService_GetClusterForVector_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *insertServiceClient) GetClusterStatus(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ClusterStatus, error) {
	out := new(ClusterStatus)
	err := c.cc.Invoke(ctx, InsertService_GetClusterStatus_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *insertServiceClient) HealthCheck(ctx context.Context, in *HealthCheckRequest, opts ...grpc.CallOption) (*HealthCheckResponse, error) {
	out := new(HealthCheckResponse)
	err := c.cc.Invoke(ctx, InsertService_HealthCheck_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *insertServiceClient) GetMetrics(ctx context.Context, in *MetricsRequest, opts ...grpc.CallOption) (*MetricsResponse, error) {
	out := new(MetricsResponse)
	err := c.cc.Invoke(ctx, InsertService_GetMetrics_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *insertServiceClient) UpdateConfig(ctx context.Context, in *ConfigUpdateRequest, opts ...grpc.CallOption) (*ConfigUpdateResponse, error) {
	out := new(ConfigUpdateResponse)
	err := c.cc.Invoke(ctx, InsertService_UpdateConfig_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *insertServiceClient) GetConfig(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ConfigUpdateResponse, error) {
	out := new(ConfigUpdateResponse)
	err := c.cc.Invoke(ctx, InsertService_GetConfig_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type InsertServiceServer interface {
	// Insert operations
	InsertVector(context.Context, *InsertRequest) (*InsertResponse, error)
	InsertVectorStream(InsertService_InsertVectorStreamServer) error
	// Batch operations
	InsertBatch(context.Context, *VectorBatch) (*InsertResponse, error)
	InsertBatchStream(InsertService_InsertBatchStreamServer) error
	// Routing and cluster management
...
// UnimplementedInsertServiceServer must be embedded to have forward compatible implementations.
...
func (UnimplementedInsertServiceServer) InsertVectorStream(InsertService_InsertVectorStreamServer) error {
	return status.Errorf(codes.Unimplemented, "method InsertVectorStream not implemented")
}
...
func (UnimplementedInsertServiceServer) InsertBatchStream(InsertService_InsertBatchStreamServer) error {
...
func _InsertService_InsertVectorStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(InsertServiceServer).InsertVectorStream(&insertServiceInsertVectorStreamServer{stream})
}

type InsertService_InsertVectorStreamServer interface {
	Send(*InsertResponse) error
	Recv() (*InsertRequest, error)
	grpc.ServerStream
}

type insertServiceInsertVectorStreamServer struct {
	grpc.ServerStream
}

func (x *insertServiceInsertVectorStreamServer) Send(m *InsertResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *insertServiceInsertVectorStreamServer) Recv() (*InsertRequest, error) {
	m := new(InsertRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func _InsertService_InsertBatchStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(InsertServiceServer).InsertBatchStream(&insertServiceInsertBatchStreamServer{stream})
}

type InsertService_InsertBatchStreamServer interface {
	Send(*InsertResponse) error
	Recv() (*VectorBatch, error)
	grpc.ServerStream
}

type insertServiceInsertBatchStreamServer struct {
	grpc.ServerStream
}

func (x *insertServiceInsertBatchStreamServer) Send(m *InsertResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *insertServiceInsertBatchStreamServer) Recv() (*VectorBatch, error) {
	m := new(VectorBatch)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type SearchServiceClient interface {
	// Search operations
	Search(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (*SearchResponse, error)
	SearchStream(ctx context.Context, opts ...grpc.CallOption) (SearchService_SearchStreamClient, error)
	// Multi-cluster search
	MultiClusterSearch(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (*SearchResponse, error)
	MultiClusterSearchStream(ctx context.Context, opts ...grpc.CallOption) (SearchService_MultiClusterSearchStreamClient, error)
	// Cluster management
	GetClusterInfo(ctx context.Context, in *ClusterInfo, opts ...grpc.CallOption) (*ClusterInfo, error)
	GetClusterStatus(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ClusterStatus, error)
	// Health and metrics
...
func (c *searchServiceClient) SearchStream(ctx context.Context, opts ...grpc.CallOption) (SearchService_SearchStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &SearchService_ServiceDesc.Streams[0], SearchService_SearchStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (x *searchServiceSearchStreamClient) Send(m *SearchRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *searchServiceSearchStreamClient) Recv() (*SearchResponse, error) {
	m := new(SearchResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *searchServiceClient) MultiClusterSearch(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (*SearchResponse, error) {
	out := new(SearchResponse)
	err := c.cc.Invoke(ctx, SearchService_MultiClusterSearch_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *searchServiceClient) MultiClusterSearchStream(ctx context.Context, opts ...grpc.CallOption) (SearchService_MultiClusterSearchStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &SearchService_ServiceDesc.Streams[1], SearchService_MultiClusterSearchStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &searchServiceMultiClusterSearchStreamClient{stream}
	return x, nil
}

type SearchService_MultiClusterSearchStreamClient interface {
	Send(*SearchRequest) error
	Recv() (*SearchResponse, error)
	grpc.ClientStream
}

type searchServiceMultiClusterSearchStreamClient struct {
	grpc.ClientStream
}

func (x *searchServiceMultiClusterSearchStreamClient) Send(m *SearchRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *searchServiceMultiClusterSearchStreamClient) Recv() (*SearchResponse, error) {
	m := new(SearchResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *searchServiceClient) GetClusterInfo(ctx context.Context, in *ClusterInfo, opts ...grpc.CallOption) (*ClusterInfo, error) {
	out := new(ClusterInfo)
	err := c.cc.Invoke(ctx, SearchService_GetClusterInfo_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *searchServiceClient) GetClusterStatus(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ClusterStatus, error) {
	out := new(ClusterStatus)
	err := c.cc.Invoke(ctx, SearchService_GetClusterStatus_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *searchServiceClient) HealthCheck(ctx context.Context, in *HealthCheckRequest, opts ...grpc.CallOption) (*HealthCheckResponse, error) {
	out := new(HealthCheckResponse)
	err := c.cc.Invoke(ctx, SearchService_HealthCheck_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *searchServiceClient) GetMetrics(ctx context.Context, in *MetricsRequest, opts ...grpc.CallOption) (*MetricsResponse, error) {
	out := new(MetricsResponse)
	err := c.cc.Invoke(ctx, SearchService_GetMetrics_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *searchServiceClient) UpdateConfig(ctx context.Context, in *ConfigUpdateRequest, opts ...grpc.CallOption) (*ConfigUpdateResponse, error) {
	out := new(ConfigUpdateResponse)
	err := c.cc.Invoke(ctx, SearchService_UpdateConfig_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *searchServiceClient) GetConfig(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ConfigUpdateResponse, error) {
	out := new(ConfigUpdateResponse)
	err := c.cc.Invoke(ctx, SearchService_GetConfig_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SearchServiceServer interface {
	// Search operations
	Search(context.Context, *SearchRequest) (*SearchResponse, error)
	SearchStream(SearchService_SearchStreamServer) error
	// Multi-cluster search
	MultiClusterSearch(context.Context, *SearchRequest) (*SearchResponse, error)
	MultiClusterSearchStream(SearchService_MultiClusterSearchStreamServer) error
	// Cluster management
	GetClusterInfo(context.Context, *ClusterInfo) (*ClusterInfo, error)
	GetClusterStatus(context.Context, *emptypb.Empty) (*ClusterStatus, error)
	// Health and metrics
...
func (UnimplementedSearchServiceServer) SearchStream(SearchService_SearchStreamServer) error {
	return status.Errorf(codes.Unimplemented, "method SearchStream not implemented")
}
...
func (UnimplementedSearchServiceServer) MultiClusterSearchStream(SearchService_MultiClusterSearchStreamServer) error {
...
func _SearchService_SearchStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(SearchServiceServer).SearchStream(&searchServiceSearchStreamServer{stream})
}
...
func (x *searchServiceSearchStreamServer) Send(m *SearchResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *searchServiceSearchStreamServer) Recv() (*SearchRequest, error) {
	m := new(SearchRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func _SearchService_MultiClusterSearchStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(SearchServiceServer).MultiClusterSearchStream(&searchServiceMultiClusterSearchStreamServer{stream})
}

type SearchService_MultiClusterSearchStreamServer interface {
	Send(*SearchResponse) error
	Recv() (*SearchRequest, error)
	grpc.ServerStream
}

type searchServiceMultiClusterSearchStreamServer struct {
	grpc.ServerStream
}

func (x *searchServiceMultiClusterSearchStreamServer) Send(m *SearchResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *searchServiceMultiClusterSearchStreamServer) Recv() (*SearchRequest, error) {
	m := new(SearchRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *adminServiceClient) AddNode(ctx context.Context, in *NodeInfo, opts ...grpc.CallOption) (*NodeInfo, error) {
	out := new(NodeInfo)
	err := c.cc.Invoke(ctx, AdminService_AddNode_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adminServiceClient) RemoveNode(ctx context.Context, in *NodeInfo, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, AdminService_RemoveNode_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adminServiceClient) UpdateNode(ctx context.Context, in *NodeInfo, opts ...grpc.CallOption) (*NodeInfo, error) {
	out := new(NodeInfo)
	err := c.cc.Invoke(ctx, AdminService_UpdateNode_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adminServiceClient) DeleteCluster(ctx context.Context, in *ClusterInfo, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, AdminService_DeleteCluster_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adminServiceClient) UpdateCluster(ctx context.Context, in *ClusterInfo, opts ...grpc.CallOption) (*ClusterInfo, error) {
	out := new(ClusterInfo)
	err := c.cc.Invoke(ctx, AdminService_UpdateCluster_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adminServiceClient) BackupSystem(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, AdminService_BackupSystem_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adminServiceClient) RestoreSystem(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, AdminService_RestoreSystem_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adminServiceClient) CompactStorage(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, AdminService_CompactStorage_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adminServiceClient) GetMetrics(ctx context.Context, in *MetricsRequest, opts ...grpc.CallOption) (*MetricsResponse, error) {
	out := new(MetricsResponse)
	err := c.cc.Invoke(ctx, AdminService_GetMetrics_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adminServiceClient) UpdateConfig(ctx context.Context, in *ConfigUpdateRequest, opts ...grpc.CallOption) (*ConfigUpdateResponse, error) {
	out := new(ConfigUpdateResponse)
	err := c.cc.Invoke(ctx, AdminService_UpdateConfig_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
